...
public class GenericLazyListScrollCDI<T> extends LazyDataModel<T> implements SelectableDataModel<T>, Serializable {
	...
	public GenericLazyListScrollCDI(Class<T> clazz, AbstractCrudBO<T> bo, T pesquisa) {
